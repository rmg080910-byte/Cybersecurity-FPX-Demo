...
function BioScanIcon(){
  return (
    <svg width="92" height="92" viewBox="0 0 92 92" fill="none" aria-hidden="true">
      <circle cx="46" cy="46" r="44" fill="#EAF1FF" stroke="#C9D9FF" strokeWidth="2"/>
      <rect x="21" y="18" width="50" height="56" rx="16" fill="#F8FBFF" stroke="#1F63E0" strokeWidth="2.8"/>
      <path d="M32 34C32 26.8 37.8 21 45 21H47C54.2 21 60 26.8 60 34V58C60 65.2 54.2 71 47 71H45C37.8 71 32 65.2 32 58V34Z" stroke="#1F63E0" strokeWidth="2.8" strokeLinecap="round"/>
      <path d="M39 36.5C39 32.4 42.4 29 46.5 29C50.6 29 54 32.4 54 36.5V55.5C54 59.6 50.6 63 46.5 63C42.4 63 39 59.6 39 55.5V36.5Z" stroke="#1F63E0" strokeWidth="2.6" strokeLinecap="round"/>
      <path d="M46.5 29V63" stroke="#7FA7FF" strokeWidth="2" strokeLinecap="round"/>
      <path d="M27 31H20M72 31H65M27 61H20M72 61H65" stroke="#A5BFF9" strokeWidth="2.6" strokeLinecap="round"/>
    </svg>
  );
}
