...
export async function ensureSchema() {
  ...
  await query(`ALTER TABLE transactions ADD COLUMN IF NOT EXISTS upload_status TEXT NOT NULL DEFAULT 'WAITING';`);
  await query(`ALTER TABLE transactions ADD COLUMN IF NOT EXISTS upload_custom_status TEXT NOT NULL DEFAULT '';`);
  ...
  `);
  await query(`CREATE INDEX IF NOT EXISTS upload_links_transaction_id_idx ON upload_links(transaction_id);`);
