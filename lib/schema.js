...
export async function ensureSchema() {
  ...
  await query(`ALTER TABLE salespersons ADD COLUMN IF NOT EXISTS staff_photo_data_url TEXT;`);
  await query(`ALTER TABLE salespersons ADD COLUMN IF NOT EXISTS photo_data_url TEXT;`);
  ...
  await query(`
    CREATE TABLE IF NOT EXISTS transactions (
      ...
      upload_custom_status TEXT,
      upload_review_status TEXT,
      upload_remark TEXT,
      created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
      updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
    );
  ...
  await query(`ALTER TABLE transactions ADD COLUMN IF NOT EXISTS upload_custom_status TEXT;`);
  await query(`ALTER TABLE transactions ADD COLUMN IF NOT EXISTS upload_review_status TEXT;`);
  await query(`ALTER TABLE transactions ADD COLUMN IF NOT EXISTS upload_remark TEXT;`);
